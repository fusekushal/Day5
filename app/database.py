import sqlite3 #helps working with sqlite3 databases
from models import Employee 

conn = sqlite3.connect("data.db") #creating a connection with SQLite database named data.db
cursor = conn.cursor() #cursor is like a tool that helps us interact with database
